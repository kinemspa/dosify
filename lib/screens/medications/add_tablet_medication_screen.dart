...
class AddTabletMedicationScreen extends StatefulWidget {
...
class _AddTabletMedicationScreenState extends State<AddTabletMedicationScreen> {
  final _formKey = GlobalKey<FormState>();
  final _nameController = TextEditingController();
  final _strengthController = TextEditingController();
  String _strengthUnit = 'mg';
  final _tabletsInStockController = TextEditingController();
  ...
  void dispose() {
    ...
    _tabletsInStockController.dispose();
    super.dispose();
  }
  ...
  Future<void> _saveMedication() async {
    ...
    try {
      print('=== TABLET MEDICATION SAVE START ===');
      ...
      try {
        inventory = double.parse(_tabletsInStockController.text);
        print('Parsed inventory: $inventory tablets');
      } catch (e) {
        print('Error parsing inventory: ${_tabletsInStockController.text}');
      ...
      print('Medication object created: ${medication.name}, ${medication.type}, ${medication.strength} ${medication.strengthUnit}, ${medication.currentInventory} tablets');
      ...
      print('=== TABLET MEDICATION SAVE END ===');
    } catch (e) {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  TextFormField(
                    controller: _tabletsInStockController,
                    keyboardType: TextInputType.number,
                    inputFormatters: [
                      FilteringTextInputFormatter.allow(RegExp(r'^\d+\.?\d{0,2}')),
                    ],
